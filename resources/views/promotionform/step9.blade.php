...
<div class="form-card">
    ...
    <div class="main border border-4 rounded rounded-5  border-danger mb-5 p-3">
        <div class="row mt-2">
            <div class="col">
                <label class="fieldlabels">Details of Patent </label> <input type="text"
                    name="details_of_patents_or_policy_document[]" placeholder="Details of Patent " @isset($patents[0]) value="{{ $patents[0]->details_of_patents_or_policy_document??'' }}" @endisset>
            </div>
            <div class="col">
                <label class="fieldlabels">International/National</label> <input type="text"
                    name="international_national_state[]" @isset($patents[0]) value="{{ $patents[0]->international_national_state??'' }}" @endisset placeholder="International/National " />
            </div>
            <div class="col">
                <label class="fieldlabels">Year</label> <input type="text"
                    name="year[]" placeholder="Year" @isset($patents[0]) value="{{ $patents[0]->year??'' }}" @endisset/>
            </div>
            <div class="col">
        ...
        <div class="add_input13">
                @isset($patents)
                    @for($j=1;$j<count($patents);$j++)
                        <div class="main ">
                            <div class="row mt-2">
                                <div class="col">
                                    <label class="fieldlabels">Details of Patent </label> <input type="text"
                                        name="details_of_patents_or_policy_document[]" placeholder="Details of Patent " @isset($patents[$j]) value="{{ $patents[$j]->details_of_patents_or_policy_document??'' }}" @endisset>
                                </div>
                                <div class="col">
                                    <label class="fieldlabels">International/National</label> <input type="text"
                                        name="international_national_state[]" @isset($patents[$j]) value="{{ $patents[$j]->international_national_state??'' }}" @endisset placeholder="International/National " />
                                </div>
                                <div class="col">
                                    <label class="fieldlabels">Year</label> <input type="text"
                                        name="year[]" placeholder="Year" @isset($patents[$j]) value="{{ $patents[$j]->year??'' }}" @endisset/>
                                </div>
                                <div class="col">
                                    <label class="fieldlabels">Claimed Score</label>
    ...
    <div class="parent14 border border-4 rounded rounded-5  border-danger mb-5 p-3">
        <div class="row mt-5">
            <div class="col">
                <label class="fieldlabels">Details of Policy Document</label> <input type="text"
                    name="details_of_patents_or_policy_document_b[]" placeholder="Details of Policy Document" @isset($policies[0]) value="{{ $policies[0]->details_of_patents_or_policy_document??'' }}" @endisset/>
            </div>
            <div class="col">
        ...
        <div class="add_input14">
            @isset($policies)
            @for($j=1;$j<count($policies);$j++)
            <div class="parent14 ">
                <div class="row mt-5">
                    <div class="col">
                        <label class="fieldlabels">Details of Policy Document</label> <input type="text"
                            name="details_of_patents_or_policy_document_b[]" placeholder="Details of Policy Document" @isset($policies[$j]) value="{{ $policies[$j]->details_of_patents_or_policy_document??'' }}" @endisset/>
                    </div>
                    <div class="col">
                        <label class="fieldlabels">International /National /State</label>
        ...
        <div class="row mt-5">
            ...
            <div class="col">
                <label class="fieldlabels">Awarding Institute/Organization</label> <input
                    ...
                    placeholder="Awarding Institute/Organization" @isset($user->step9_b[0]) value="{{ $user->step9_b[0]->awarding_institute_organization }}" @endisset />
            </div>
            <div class="col">
                <label class="fieldlabels">International/ National</label> <input type="text"
                    name="international_national_state[]" placeholder="International/ National"  @isset($user->step9_b[0]) value="{{ $user->step9_b[0]->international_national_state }}" @endisset/>
            </div>
        </div>
        <div class="row mt-2">
            <div class="col">
                ...
                <input type="text" name="date_awarded[]"
                    placeholder="Grant Sanctioned" @isset($user->step9_b[0]) value="{{ $user->step9_b[0]->date_awarded }}" @endisset />
            </div>
            <div class="col">
                <label class="fieldlabels">Claimed Score</label>
            ...
            <div class="col">
                ...
                <input type="text" name="verify_by_committee[]"
                    placeholder="Verified by the Committee"  @isset($user->step9_b[0]) value="{{ $user->step9_b[0]->verify_by_committee }}" @endisset/>
            </div>
            <div class="col">
                <label class="fieldlabels">Encl. No.</label>
            ...
            <div class="col">
                ...
                <input type="file" name="award_file_b[]"
                    placeholder="Encl. No." @isset($user->step9_b[0]) {{ $user->step9_b[0]->file?'required':'' }} @endisset />
            </div>
            <div class="col-1">
                    ...
                    <div class="parent15">
                        <div class="row mt-5">
                            ...
                            <div class="col">
                                <label class="fieldlabels">Awarding Institute/Organization</label> <input
                                    type="text" name="awarding_institute_organization[]"
                                    placeholder="Awarding Institute/Organization" @isset($user->step9_b[$j]) value="{{ $user->step9_b[$j]->awarding_institute_organization }}" @endisset />
                            </div>
                            <div class="col">
                                <label class="fieldlabels">International/ National</label> <input type="text"
                                    name="international_national_state[]" placeholder="International/ National"  @isset($user->step9_b[$j]) value="{{ $user->step9_b[$j]->international_national_state }}" @endisset/>
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col">
                                <label class="fieldlabels">Date Awarded </label>
                                <input type="text" name="date_awarded[]"
                                    placeholder="Grant Sanctioned" @isset($user->step9_b[$j]) value="{{ $user->step9_b[$j]->date_awarded }}" @endisset />
                            </div>
                            <div class="col">
                                <label class="fieldlabels">Claimed Score</label>
                            ...
                            <div class="col">
                                <label class="fieldlabels">Verified by the Committee</label>
                                <input type="text" name="verify_by_committee[]"
                                    placeholder="Verified by the Committee"  @isset($user->step9_b[$j]) value="{{ $user->step9_b[$j]->verify_by_committee }}" @endisset/>
                            </div>
                            <div class="col">
                                <label class="fieldlabels">Encl. No.</label>
                            ...
                            <div class="col">
                                <label class="fieldlabels">File </label>
                                <input type="file" name="award_file_b[]"
                                    placeholder="Encl. No." @isset($user->step9_b[$j]) {{ $user->step9_b[$j]->file?'required':'' }} @endisset />
                            </div>
                            <div class="col-1">
        ...
        <div class="row mt-5">
            ...
            <div class="col">
                <label class="fieldlabels">Name of the Event</label> <input
                    ...
                    placeholder="Name of the Event" @isset($user->step9_c[0]) value="{{ $user->step9_c[0]->name_of_the_event??'' }}"  @endisset />
            </div>
            <div class="col">
                <label class="fieldlabels">Invited/Oral/Poster</label> <input type="text"
                    name="invited_or_al_poster[]" placeholder="Invited/Oral/Poster" @isset($user->step9_c[0]) value="{{ $user->step9_c[0]->invited_or_al_poster??'' }}"  @endisset />
            </div>
            <div class="col">
                <label class="fieldlabels">Organiser/Institute</label>
                <input type="text" name="organiser_institute[]"
                    placeholder="Organiser/Institute" @isset($user->step9_c[0]) value="{{ $user->step9_c[0]->organiser_institute??'' }}"  @endisset />
            </div>
            <div class="col">
        ...
        <div class="row mt-2">
            ...
            <div class="col">
                ...
                <input type="text" name="international_national_state[]"
                    placeholder="International(Abroad)/Internation al(within  country) / National / State / University level"  @isset($user->step9_c[0]) value="{{ $user->step9_c[0]->international_national_state??'' }}"  @endisset />
            </div>
            <div class="col">
                <label class="fieldlabels">Claimed Score</label>
            ...
            <div class="col">
                ...
                <input type="text" name="inv_encl_no[]"
                    placeholder="Encl. No." @isset($user->step9_c[0]) value="{{ $user->step9_c[0]->encl_no??'' }}"  @endisset  />
            </div>
            <div class="col">
                <label class="fieldlabels">File</label>
                    ...
                    <div class="parent16 border border-4 rounded rounded-5  border-danger mb-5 p-3">
                        <div class="row mt-5">
                            ...
                            <div class="col">
                                <label class="fieldlabels">Name of the Event</label> <input
                                    type="text" name="name_of_the_event[]"
                                    placeholder="Name of the Event" @isset($user->step9_c[$k]) value="{{ $user->step9_c[$k]->name_of_the_event??'' }}"  @endisset />
                            </div>
                            <div class="col">
                                <label class="fieldlabels">Invited/Oral/Poster</label> <input type="text"
                                    name="invited_or_al_poster[]" placeholder="Invited/Oral/Poster" @isset($user->step9_c[$k]) value="{{ $user->step9_c[$k]->invited_or_al_poster??'' }}"  @endisset />
                            </div>
                            <div class="col">
                                <label class="fieldlabels">Organiser/Institute</label>
                                <input type="text" name="organiser_institute[]"
                                    placeholder="Organiser/Institute" @isset($user->step9_c[$k]) value="{{ $user->step9_c[$k]->organiser_institute??'' }}"  @endisset />
                            </div>
                            <div class="col">
                                <label class="fieldlabels">Duration</label>
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col">
                                <label class="fieldlabels">International(Abroad)/Internation al(within  country) / National / State / University level</label>
                                <input type="text" name="international_national_state[]"
                                    placeholder="International(Abroad)/Internation al(within  country) / National / State / University level"  @isset($user->step9_c[$k]) value="{{ $user->step9_c[$k]->international_national_state??'' }}"  @endisset />
                            </div>
                            <div class="col">
                                <label class="fieldlabels">Claimed Score</label>
                            ...
                            <div class="col">
                                <label class="fieldlabels">Encl. No.</label>
                                <input type="text" name="inv_encl_no[]"
                                    placeholder="Encl. No." @isset($user->step9_c[$k]) value="{{ $user->step9_c[$k]->encl_no??'' }}"  @endisset  />
                            </div>
                            <div class="col">
                                <label class="fieldlabels">File</label>
