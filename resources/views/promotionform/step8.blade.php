...
<form action="{{ route('promotion-form.step-8-store') }}" method="post" enctype="multipart/form-data">
    ...
    <div class="form-card">
        ...
        <div class="parent10 border border-4 rounded rounded-5  border-danger mb-5 p-3">
            <div class="row mt-2">
                <div class="col">
                    <label class="fieldlabels">Name of the Scholar</label> <input type="text" name="Name_of_the_Scholar[]" placeholder="Name of the Scholar" @isset($phd[0]) value="{{ $phd[0]->name_of_the_scholar??'' }}" @endisset />
                </div>
                <div class="col">
                    <label class="fieldlabels">University </label> <input type="text" name="University[]" placeholder="University " @isset($phd[0]) value="{{ $phd[0]->university??'' }}" @endisset />
                </div>
                <div class="col">
                    <label class="fieldlabels">Title of the Thesis</label> <input type="text" name="Title_of_the_Thesis[]" placeholder="Title of the Thesis" @isset($phd[0]) value="{{ $phd[0]->thesis??'' }}" @endisset />
                </div>
                <div class="col">
                    <label class="fieldlabels">Awarded/Thesis submitted</label> <input type="text" name="Awarded_Thesis_submitted[]" placeholder="Awarded/Thesis submitted" @isset($phd[0]) value="{{ $phd[0]->awarded_thesis_submitted??'' }}" @endisset />
                </div>
                <div class="col">
            ...
            <div class="row mt-2">
                <div class="col">
                    ...
                    <input type="text" name="Month_and_Year[]" placeholder="Month and Year" @isset($phd[0]) value="{{ $phd[0]->month_and_year??'' }}" @endisset />
                </div>
                <div class="col">
                    <label class="fieldlabels">Verified by the Committee</label>
                    <input type="text" name="Verified_by_the_Committee[]" @isset($phd[0]) value="{{ $phd[0]->verify_by_committee??'' }}" @endisset placeholder="Verified by the Committee" />
                </div>
                <div class="col">
                ...
                <div class="col">
                    ...
                    <input type="text" name="encl_no[]" placeholder="Encl. No." @isset($phd[0]) value="{{ $phd[0]->encl_no??'' }}" @endisset />
                </div>
                <div class="col-1">
    ...
    <div class="parent11 border border-4 rounded rounded-5  border-danger mb-5 p-3">
        <div class="row mt-5">
            <div class="col">
                <label class="fieldlabels">No. of the Scholar</label> <input type="text" name="Name_of_the_Scholar_b[]" @isset($mphil[0]) value="{{ $mphil[0]->name_of_the_scholar??'' }}" @endisset placeholder="No of the Scholar" />
            </div>
            <div class="col">
                <label class="fieldlabels">M.Phil./ P.G.</label> <input type="text" name="M_Phil_P_G_b[]" placeholder="M.Phil./ P.G." @isset($mphil[0]) value="{{ $mphil[0]->mphil_phd??'' }}" @endisset />
            </div>
            <div class="col">
                <label class="fieldlabels">Name Of The Department</label> <input type="text" name="Title_of_the_Thesis_b[]" placeholder="Title of the Thesis" @isset($mphil[0]) value="{{ $mphil[0]->thesis??'' }}" @endisset />
            </div>
            <div class="col">
                <label class="fieldlabels">University / College</label> <input type="text" name="University_b[]" placeholder="University" @isset($mphil[0]) value="{{ $mphil[0]->university??'' }}" @endisset />
            </div>
            <div class="col">
        ...
        <div class="row mt-2">
            <div class="col">
                <label class="fieldlabels">Month and Year</label>
                <input type="month" name="Month_and_Year_b[]" placeholder="Month and Year" @isset($mphil[0]) value="{{ $mphil[0]->month_and_year??'' }}" @endisset />
            </div>
            <div class="col">
                <label class="fieldlabels">Verified by the Committee</label>
                <input type="text" name="Verified_by_the_Committee_b[]" placeholder="Verified by the Committee" @isset($mphil[0]) value="{{ $mphil[0]->verify_by_committee??'' }}" @endisset />
            </div>
            <div class="col">
                <label class="fieldlabels">Claimed Score</label>
            ...
            <div class="col">
                <label class="fieldlabels">Encl. No.</label>
                <input type="text" name="encl_no_b[]" placeholder="Encl. No." @isset($mphil[0]) value="{{ $mphil[0]->encl_no??'' }}" @endisset />
            </div>
            <div class="col-1">
        ...
        <div class="add_input11">
            ...
            @for($j=0;$j<count($mphil);$j++) <div class="parent11 ">
                ...
                <div class="row mt-5">
                    <div class="col">
                        <label class="fieldlabels">No. of the Scholar</label> <input type="text" name="Name_of_the_Scholar_b[]" @isset($mphil[$j]) value="{{ $mphil[$j]->name_of_the_scholar??'' }}" @endisset placeholder="No of the Scholar" />
                    </div>
                    <div class="col">
                        <label class="fieldlabels">M.Phil./ P.G.</label> <input type="text" name="M_Phil_P_G_b[]" placeholder="M.Phil./ P.G." @isset($mphil[$j]) value="{{ $mphil[$j]->mphil_phd??'' }}" @endisset />
                    </div>
                    <div class="col">
                        <label class="fieldlabels">Name Of The Department</label> <input type="text" name="Title_of_the_Thesis_b[]" placeholder="Title of the Thesis" @isset($mphil[$j]) value="{{ $mphil[$j]->thesis??'' }}" @endisset />
                    </div>
                    <div class="col">
                        <label class="fieldlabels">University / College</label> <input type="text" name="University_b[]" placeholder="University" @isset($mphil[$j]) value="{{ $mphil[$j]->university??'' }}" @endisset />
                    </div>
                    <div class="col">
                ...
                <div class="row mt-2">
                    <div class="col">
                        <label class="fieldlabels">Month and Year</label>
                        <input type="month" name="Month_and_Year_b[]" placeholder="Month and Year" @isset($mphil[$j]) value="{{ $mphil[$j]->month_and_year??'' }}" @endisset />
                    </div>
                    <div class="col">
                        <label class="fieldlabels">Verified by the Committee</label>
                        <input type="text" name="Verified_by_the_Committee_b[]" placeholder="Verified by the Committee" @isset($mphil[$j]) value="{{ $mphil[$j]->verify_by_committee??'' }}" @endisset />
                    </div>
                    <div class="col">
                        <label class="fieldlabels">Claimed Score</label>
                    ...
                    <div class="col">
                        <label class="fieldlabels">Encl. No.</label>
                        <input type="text" name="encl_no_b[]" placeholder="Encl. No." @isset($mphil[$j]) value="{{ $mphil[$j]->encl_no??'' }}" @endisset />
                    </div>
                    <div class="col-1">
    ...
    <div class="parent12 border border-4 rounded rounded-5  border-danger mb-5 p-3">
        ...
        <div class="row mt-2">
            ...
            <div class="col">
                <label class="fieldlabels">Claimed Score</label>
                <input type="number" name="Claimed_Score[]" placeholder="Claimed Score" @isset($user->step8_b[0]) value="{{ $user->step8_b[0]->claimed_score??'' }}" @endisset/>
            </div>
            <div class="col">
            ...
            @for($j=1;$j<count($user->step8_b);$j++)
                <div class="parent12 ">
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col">
                            <label class="fieldlabels">Claimed Score</label>
                            <input type="number" name="Claimed_Score[]" placeholder="" @isset($user->step8_b[$j]) value="{{ $user->step8_b[$j]->claimed_score??'' }}" @endisset/>
                        </div>
                        <div class="col">
                            <label class="fieldlabels">Duration (from)</label>
...
<script>
    ...
    <div class="parent11 ">
        <div class="row mt-5">
            <div class="col">
                <label class="fieldlabels">Name of the Scholar</label> <input type="text"
                    name="Name_of_the_Scholar_b[]" placeholder="Name of the Scholar" />
            </div>
            <div class="col">
                <label class="fieldlabels">M.Phil./ P.G.</label> <input type="text"
                    name="M_Phil_P_G_b[]" placeholder="M.Phil./ P.G."/>
            </div>
            <div class="col">
                <label class="fieldlabels">Name Of The Department</label> <input type="text"
                    name="Title_of_the_Thesis_b[]" placeholder="Title of the Thesis" />
            </div>
            <div class="col">
                <label class="fieldlabels">University / College</label> <input
                    type="text" name="University_b[]"
        ...
        <div class="row mt-2">
            <div class="col">
                <label class="fieldlabels">Month and Year</label>
                <input type="month" name="Month_and_Year_b[]" placeholder="Month and Year" />
            </div>
            <div class="col">
                <label class="fieldlabels">Verified by the Committee</label>
                <input type="text" name="Verified_by_the_Committee_b[]"
                    placeholder="Verified by the Committee" />
            </div>
            <div class="col">
                <label class="fieldlabels">Claimed Score</label>
