...
<div class="form-card">
        ...
        <div class="row mt-2">
            <div class="col">
                <label class="fieldlabels">Name of the Scholar</label> <input type="text"
                    name="Name_of_the_Scholar[]" placeholder="Name of the Scholar"  @isset($phd[0]) value="{{ $phd[0]->name_of_the_scholar??'' }}" @endisset/>
            </div>
            <div class="col">
                <label class="fieldlabels">University </label> <input type="text"
                    name="University[]" placeholder="University "  @isset($phd[0]) value="{{ $phd[0]->university??'' }}" @endisset />
            </div>
            <div class="col">
                <label class="fieldlabels">Title of the Thesis</label> <input type="text"
                    name="Title_of_the_Thesis[]" placeholder="Title of the Thesis"  @isset($phd[0]) value="{{ $phd[0]->thesis??'' }}" @endisset />
            </div>
            <div class="col">
                <label class="fieldlabels">Awarded/Thesis submitted</label> <input
                    type="text" name="Awarded_Thesis_submitted[]" placeholder="Awarded/Thesis submitted"  @isset($phd[0]) value="{{ $phd[0]->awarded_thesis_submitted??'' }}" @endisset/>
            </div>
            <div class="col">
    ...
    <div class="parent11 border border-4 rounded rounded-5  border-danger mb-5 p-3">
        <div class="row mt-5">
            ...
            <div class="col">
                <label class="fieldlabels">M.Phil./ P.G.</label> <input type="text"
                    name="M_Phil_P_G_b[]" placeholder="M.Phil./ P.G." @isset($mphil[0]) value="{{ $mphil[0]->mphil_phd??'' }}" @endisset/>
            </div>
            <div class="col">
                <label class="fieldlabels">Name Of The Department</label> <input type="text"
                    name="Title_of_the_Thesis_b[]" placeholder="Title of the Thesis" @isset($mphil[0]) value="{{ $mphil[0]->thesis??'' }}" @endisset />
            </div>
            <div class="col">
                <label class="fieldlabels">University / College</label> <input
                    type="text" name="University_b[]"
                    placeholder="University" @isset($mphil[0]) value="{{ $mphil[0]->university??'' }}" @endisset />
            </div>
            <div class="col">
        ...
        <div class="add_input11">
            @isset($mphil[0])
                @for($j=0;$j<count($mphil);$j++)
                <div class="parent11 "><hr/>
                    <div class="row mt-5">
                        <div class="col">
                        ...
                        <div class="col">
                            <label class="fieldlabels">M.Phil./ P.G.</label> <input type="text"
                                name="M_Phil_P_G_b[]" placeholder="M.Phil./ P.G." @isset($mphil[$j]) value="{{ $mphil[$j]->mphil_phd??'' }}" @endisset/>
                        </div>
                        <div class="col">
                            <label class="fieldlabels">Name Of The Department</label> <input type="text"
                                name="Title_of_the_Thesis_b[]" placeholder="Title of the Thesis" @isset($mphil[$j]) value="{{ $mphil[$j]->thesis??'' }}" @endisset />
                        </div>
                        <div class="col">
                            <label class="fieldlabels">University / College</label> <input
                                type="text" name="University_b[]"
                                placeholder="University" @isset($mphil[$j]) value="{{ $mphil[$j]->university??'' }}" @endisset />
                        </div>
                        <div class="col">
                            <label class="fieldlabels">File (Attachement)</label> <input
...
<button type="submit" href="{{ route('promotion-form.step-8-store') }}" class="action-button">Next</button>
