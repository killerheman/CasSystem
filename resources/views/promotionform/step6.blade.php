        ...
        <div class="row g-3">
            ...
            <div class="col-sm-5">
                <label for="teaching">Teaching= (Number of Classes Taught / Total Classes Assigned) X
                    100%</label>
                <input type="text" id="teaching" name="teaching[]" class="form-control" value="@isset($user->step6[0]) {{ $user->step6[0]->number_of_classes_tought??'' }} @endisset"
            ...
            <div class="col-sm-3">
                ...
                <input type="file" id="activity_file" name="activity_file[]" class="form-control" 
                    placeholder="activity_file" aria-label="activity_file" @isset($user->step6[0]) {{ $user->step6[0]->A1_file?'required':'' }} @endisset >
                ...
                <div class="parent">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-sm-3">
                            <label for="activity_file">File Attachement</label>
                            <input type="file" id="activity_file" name="activity_file[]" class="form-control" 
                                placeholder="activity_file" aria-label="activity_file" @isset($user->step6[$j]) {{ $user->step6[$j]->A1_file?'required':'' }} @endisset>
        ...
        <div class="row g-3">
            <div class="col-md-2">
                ...
                <input type="text" id="research_paper" name="research_paper[]" class="form-control"
                    placeholder="Title of the Research Paper" aria-label="research_paper"  value="@isset($user->step6_c[0]) {{ $user->step6_c[0]->title_research_chapter??'' }} @endisset">
            </div>
            <div class="col-md-2">
                <label for="name_journal">Name of the Journal</label>
                <input type="text" id="name_journal" name="name_journal[]" class="form-control"
                    placeholder="Name of the Journal" aria-label="name_journal" value="@isset($user->step6_c[0]) {{ $user->step6_c[0]->name_journal??'' }} @endisset">
            </div>
            <div class="col-md-2">
                ...
                <input type="text" id="vol_pp_year" name="vol_pp_year[]" class="form-control" placeholder="Vol., PP No. & Year"
                    aria-label="Vol., PP No. & Year" value="@isset($user->step6_c[0]) {{ $user->step6_c[0]->vol_pp_no_year??'' }} @endisset">
            </div>
            <div class="col-md-2">
                ...
                <input type="text" id="impact_factor" name="impact_factor[]" class="form-control" placeholder="Impact Factor"
                    aria-label="impact_factor" value="@isset($user->step6_c[0]) {{ $user->step6_c[0]->impact_factor??'' }} @endisset">
            </div>
            <div class="col-md-2">
                ...
                <input type="text" id="name_authors" name="name_authors[]" class="form-control" placeholder="Number of authors"
                    aria-label="name_authors" value="@isset($user->step6_c[0]) {{ $user->step6_c[0]->no_authors??'' }} @endisset">
            </div>
            <div class="col-md-2">
                ...
                <input type="file" id="research_file" name="research_file[]" class="form-control" placeholder="research_file"
                    aria-label="research_file" @isset($user->step6_c[0]) {{ $user->step6_c[0]->file?'required':'' }} @endisset>
        ...
        <div class="row g-3">
            <div class="col-sm-4">
                ...
                <input type="text" id="authorship" name="authorship[]" class="form-control" placeholder="Type of Authorship"
                    aria-label="authorship"  value="@isset($user->step6_c[0]) {{ $user->step6_c[0]->type_authorship??'' }} @endisset">
            </div>
            <div class="col-sm-2">
            ...
            <div class="col-sm-2">
                ...
                <input type="text" id="verified_committee" name="verified_committee_c[]" class="form-control" placeholder="Verified by the Committee"
                    aria-label="verified_committee" value="@isset($user->step6_c[0]) {{ $user->step6_c[0]->varified_by_committee??'' }} @endisset">
            </div>
            <div class="col-sm-2">
            ...
            <div class="col-sm-1">
                ...
                <input type="text" id="Encl" name="encl_no_c[]" class="form-control" placeholder="Encl.No"
                    aria-label="Encl" value="@isset($user->step6_c[0]) {{ $user->step6_c[0]->encl_no??'' }} @endisset">
            </div>
            <div class="col-md-1 mt-5">
                    ...
                    <div class="parent2"><hr/>
                        <div class="row g-3">
                            <div class="col-md-2">
                                <label for="research_paper">Title of the Research Paper</label>
                                <input type="text" id="research_paper" name="research_paper[]" class="form-control"
                                    placeholder="Title of the Research Paper" aria-label="research_paper"  value="@isset($user->step6_c[$g]) {{ $user->step6_c[$g]->title_research_chapter??'' }} @endisset">
                            </div>
                            <div class="col-md-2">
                                <label for="name_journal">Name of the Journal</label>
                                <input type="text" id="name_journal" name="name_journal[]" class="form-control"
                                    placeholder="Name of the Journal" aria-label="name_journal" value="@isset($user->step6_c[$g]) {{ $user->step6_c[$g]->name_journal??'' }} @endisset">
                            </div>
                            <div class="col-md-2">
                                <label for="vol_pp_year">Vol., PP No. & Year</label>
                                <input type="text" id="vol_pp_year" name="vol_pp_year[]" class="form-control" placeholder="Vol., PP No. & Year"
                                    aria-label="Vol., PP No. & Year" value="@isset($user->step6_c[$g]) {{ $user->step6_c[$g]->vol_pp_no_year??'' }} @endisset">
                            </div>
                            <div class="col-md-2">
                                <label for="impact_factor*">Impact Factor*</label>
                                <input type="text" id="impact_factor" name="impact_factor[]" class="form-control" placeholder="Impact Factor"
                        ...
                        <div class="row g-3">
                            <div class="col-sm-4">
                                <label for="authorship*">Type of Authorship (First author/corresponding author/principal/co-author)</label>
                                <input type="text" id="authorship" name="authorship[]" class="form-control" placeholder="Type of Authorship"
                                    aria-label="authorship"  value="@isset($user->step6_c[$g]) {{ $user->step6_c[$g]->type_authorship??'' }} @endisset">
                            </div>
                            <div class="col-sm-2">
                                <label for="UGC_listed_journals*">Sr. No. in UGC listed Journals</label>
                                <input type="text" id="UGC_listed_journals" name="UGC_listed_journals[]" class="form-control" placeholder="UGC listed Journals"
                                    aria-label="UGC_listed_journals" value="@isset($user->step6_c[$g]) {{ $user->step6_c[$g]->sr_in_ugc??'' }} @endisset">
                            </div>
                            <div class="col-sm-2">
                                <label for="verified_committee*">Verified by the Committee</label>
                                <input type="text" id="verified_committee" name="verified_committee_c[]" class="form-control" placeholder="Verified by the Committee"
                                    aria-label="verified_committee" value="@isset($user->step6_c[$g]) {{ $user->step6_c[$g]->varified_by_committee??'' }} @endisset">
                            </div>
                            <div class="col-sm-2">
                                <label for="claimed_score*">Claimed Score</label>
                                <input type="text" id="claimed_score" name="claimed_score[]" class="form-control" placeholder="Claimed Score"
                            ...
                            <div class="col-sm-1">
                                <label for="Encl*">Encl.No.</label>
                                <input type="text" id="Encl" name="encl_no_c[]" class="form-control" placeholder="Encl.No"
                                    aria-label="Encl" value="@isset($user->step6_c[$g]) {{ $user->step6_c[$g]->encl_no??'' }} @endisset">
                            </div>
                            <div class="col-md-1 mt-5">
